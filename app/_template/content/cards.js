export const CARDS = [
    ...
    {
        title: "Billing",
        description: "Subscription billing without the headache: add subscription billing to your application with a few clicks and start collecting money.",
...
export const DASHBOARD_CARDS = [
    ...
    },
    {
        ...
        description: "Customize the look and feel of your application with Clerk's prebuilt components.",
