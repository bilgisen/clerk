...
export const users = pgTable('users', {
  ...
  // Book Quotas
  monthlyBookQuota: integer('monthly_book_quota').default(1),
  booksCreatedThisMonth: integer('books_created_this_month').default(0),
  totalBooksCreated: integer('total_books_created').default(0),
  lastBookCreatedAt: timestamp('last_book_created_at'),
...
export const subscriptionPlans = pgTable('subscription_plans', {
  ...
  monthlyBookQuota: integer('monthly_book_quota').notNull(),
