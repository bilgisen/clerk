...
export function SimpleEditor({ content = '', onChange, className = '', editorProps = {}, editable = true }) {
    ...
    // Set up transaction handler for content changes
    React.useEffect(() => {
        if (!editor || !onChange)
            return;
        const handleUpdate = () => {
    ...
    return (<div className={`simple-editor-wrapper ${className}`}>
      <EditorContext.Provider value={{ editor }}>
        ...
        <EditorContent editor={editor} role="presentation" className="simple-editor-content" style={{
            minHeight: '200px',
            outline: 'none',
            padding: '1rem',
            ...(editable === false ? { pointerEvents: 'none', opacity: 0.8 } : {})
        }}/>
