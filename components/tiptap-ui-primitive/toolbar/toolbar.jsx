...
const useSeparatorVisibility = (ref) => {
    ...
    const checkVisibility = React.useCallback(() => {
        ...
        const areBothGroups = prevSibling.getAttribute("role") === "group" &&
...
export const Toolbar = React.forwardRef(({ children, className, variant = "fixed", ...props }, ref) => {
    ...
    if (!isVisible)
        return null;
    return (<div ref={mergeRefs([toolbarRef, ref])} role="toolbar" aria-label="toolbar" data-variant={variant} className={cn("tiptap-toolbar", className)} {...props}>
        {children}
      </div>);
});
...
export const ToolbarGroup = React.forwardRef(({ children, className, ...props }, ref) => {
    ...
    if (!isVisible)
        return null;
    return (<div ref={mergeRefs([groupRef, ref])} role="group" className={cn("tiptap-toolbar-group", className)} {...props}>
        {children}
      </div>);
});
ToolbarGroup.displayName = "ToolbarGroup";
export const ToolbarSeparator = React.forwardRef(({ fixed = false, ...props }, ref) => {
